...
public class ScrollingUtil {
    ...
    public static boolean isViewToBottom(View view, int mTouchSlop) {
        ...
        if (view instanceof QuanNestedScrollView) return isViewQuanNestedScrollView((QuanNestedScrollView) view);
        if (view instanceof ViewGroup) return isViewGroupToBottom((ViewGroup) view);
        return false;
    }

    private static boolean isViewQuanNestedScrollView(QuanNestedScrollView view) {
