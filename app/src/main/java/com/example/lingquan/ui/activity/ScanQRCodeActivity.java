...
public class ScanQRCodeActivity extends FragmentActivity {
    ...
    public void handleDecode(Result result) {
        ...
        if (result1.contains("taobao.com")) {
            IkoulingPresenter koulingPersenter =
                    PersenterManager.getInstance().getKoulingPersenter();
            koulingPersenter.getkouling("", result1, "");
            startActivity(new Intent(this, KouLingActivity.class));
        }else {
            ToastUtitls.showToast("二维码非法，不属于淘宝领券码");
        }
//        if (mScanerListener == null) {
